namespace WebGLJS {
    ...
    export class ShaderAttribute extends ShaderProperty implements IBindable {
        ...
        */
        ...
        toString() { return "Attribute " + this.name + " (location=" + this.location + ")"; }
    ...
    export class ShaderUniform extends ShaderProperty implements IBindable {
        ...
        toString() { return "Uniform '" + this.name + "'"; }
    ...
    export class VertexAttributePointer {
        ...
        constructor(public readonly attribute: ShaderAttribute, public attributeLocation: number, public componentSize?: ComponentSize, public type?: ComponentType, public normalized?: boolean, public stride?: number, public offset?: number) {
            ...
            if (!attribute.shader) throw this._error("'attribute.shader' is required.");
            if (!attribute.shader.ctx) throw this._error("'attribute.shader.ctx' is required.");
        ...
        bind(): this {
            ...
            if (!gl) throw this._error("WebGL not supported.");
            if (!buffer) throw this._error("A buffer is required in order to set an attribute pointer for it. Call 'setBuffer()' on the attribute, or set the 'sharedBuffer' property on the shader program.");
