...
interface SharedArrayBuffer { } // JW: Placeholder for now
...
interface WebGL2RenderingContext extends WebGLRenderingContext {
    ...
    transformFeedbackVaryings(program: WebGLProgram | null, varyings: string[], bufferMode: number): void; // JW: Was missing the 'g' in 'Varyings'!
