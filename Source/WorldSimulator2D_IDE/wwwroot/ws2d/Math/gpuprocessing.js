...
(function (WorldSimulator2D) {
    ...
    (function (MathPiplines) {
        MathPiplines.GPU_KERNAL_MAX_DATA_PER_OBJECT = 32;
        MathPiplines.processCode_vs = function (gl, varyings) {
        ...
        MathPiplines.processCode_fs = function (gl) {
            return "#version 300 es\n\
        ...
        })(ParticleRenderInputs = MathPiplines.ParticleRenderInputs || (MathPiplines.ParticleRenderInputs = {}));
        MathPiplines.renderCode_vs = function (gl) {
            return "#version 300 es\n\
                #ifdef GL_ES\n\
                    precision highp float;\n\
                    precision highp int;\n\
        ...
        MathPiplines.renderCode_fs = function (gl) {
