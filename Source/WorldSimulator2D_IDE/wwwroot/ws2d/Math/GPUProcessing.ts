namespace WorldSimulator2D {
    ...
    export namespace MathPipelines {
        ...
        export var GPU_KERNAL_MAX_DATA_PER_OBJECT = 32; // (becomes the 'width' constant)
         ...
         */
        export var processCode_vs = (gl: WebGL, varyings: string[]) => { // (WebGL 1->2: https://webgl2fundamentals.org/webgl/lessons/webgl1-to-webgl2.html)
            if (!varyings || !varyings.length) throw Error("'varyings' is required, and cannot be empty.");
         ...
         * @param gl A reference to the WebGL wrapper instance for this script (required to detect version information).
         */
        export var processCode_fs = (gl: WebGL) => { // (WebGL 1->2: https://webgl2fundamentals.org/webgl/lessons/webgl1-to-webgl2.html)
            return "#version 300 es\n\
        ...
        export enum ParticleRenderInputs {
         ...
         * @param gl A reference to the WebGL wrapper instance for this script (required to detect version information).
         */
        export var renderCode_vs = (gl: WebGL) => {
            return "#version 300 es\n\
                #ifdef GL_ES\n\
                    precision highp float;\n\
                    precision highp int;\n\
         ...
         * @param gl A reference to the WebGL wrapper instance for this script (required to detect version information).
         */
        export var renderCode_fs = (gl: WebGL) => {
